...
def RecordingEP(recording: object) -> int:
    ...
    def get_series_id(str_to_check, recording):
        ...
        #         string_end = "_4mm_PA" # resolution of B1 AFI maps pTx
            ...
            # logger.warning(f"ProtocolName couldn't be derived properly from {full_string}") # comment out for liege LORAKS data (already pseudo-bidsified) -> just set str_to_check as protocol name
            return str_to_check
