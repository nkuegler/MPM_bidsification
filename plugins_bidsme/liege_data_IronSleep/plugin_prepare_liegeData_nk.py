...
def RecordingEP(recording: object) -> int:
    ...
    if recording.Module() == "MRI":
        ...
        ### In the pseudo-bidsified LiegeData, the recording files are not stored in sequence directories. Therefore, this counting is performed on the RecordingEP instead of the SequenceEP.
